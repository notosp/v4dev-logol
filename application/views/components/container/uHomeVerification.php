...
<head>
        ...
        <meta charset="utf-8" />
        <title>List Registrant | LOGOL V.4</title>
        <!-- App favicon -->
        ...
        <link href="<?=  base_url() ?>assets/css/customs.min.css" rel="stylesheet" type="text/css" />
        <!-- App Css-->
                        ...
                        <div class="row">
                            ...
                            <script>
                                function search(sel){
                                    ...
                                    window.location.href = "<?= site_url("home/verification") ?>?cp="+cp+"&pt="+pt
                                }
                            </script>
                            <div class="card">
                                    <div class="card-body">
...
<path d="M3 1H9C9.13261 1 9.25979 1.05268 9.35355 1.14645C9.44732 1.24021 9.5 1.36739 9.5 1.5V10.5C9.5 10.6326 9.44732 10.7598 9.35355 10.8536C9.25979 10.9473 9.13261 11 9 11H3C2.86739 11 2.74021 10.9473 2.64645 10.8536C2.55268 10.7598 2.5 10.6326 2.5 10.5V1.5C2.5 1.36739 2.55268 1.24021 2.64645 1.14645C2.74021 1.05268 2.86739 1 3 1ZM6 8.5C5.86739 8.5 5.74021 8.55268 5.64645 8.64645C5.55268 8.74021 5.5 8.86739 5.5 9C5.5 9.13261 5.55268 9.25979 5.64645 9.35355C5.74021 9.44732 5.86739 9.5 6 9.5C6.13261 9.5 6.25979 9.44732 6.35355 9.35355C6.44732 9.25979 6.5 9.13261 6.5 9C6.5 8.86739 6.44732 8.74021 6.35355 8.64645C6.25979 8.55268 6.13261 8.5 6 8.5Z" fill="#8C8CA2"/>
                                                    ...
                                                    <td style="border-left:1px solid #e9e9ef;">
                                                        <div class="mb-2">
                                                            <button onclick="setAction('verify', '<?php echo $row['COMPANY_ID'] ?>', '<?php echo $row['USER_ID'] ?>', 'GET')" data-bs-toggle="modal" data-bs-target="#verify" type="button" style="border-color: #ECF1F4; border-width:2px; color: #497DF5;font-weight: bold; font-size: 8px;" class="btn btn btn-outline-secondary position-relative">
                                                                Verify
                                                            </button>
                                                        ...
                                                        <div>
                                                            <button onclick="setAction('reject', '<?php echo $row['COMPANY_ID'] ?>', '<?php echo $row['USER_ID'] ?>', 'GET')"  data-bs-toggle="modal" data-bs-target="#verify" type="button" style="border-color: #ECF1F4; border-width:2px;font-weight: bold; font-size: 8px;" class="btn btn btn-outline-secondary position-relative">
                                                                Reject
                                                            </button>
                                                        </div>
                                                    </td>
                                                ...
                                                <script>
                                                    function doReq(){
                                                        ...
                                                        if(values === "Verify Confirmation" || values === "Reject Confirmation"){
                                                            ...
                                                            $.ajax({
                                                                    url: "<?= site_url("home/actVerify/") ?>"+url,
                                                                    type: "post",
                                                                    data: {
                                                                        action : values,
                                                                        cid: $("#cid").text(),
