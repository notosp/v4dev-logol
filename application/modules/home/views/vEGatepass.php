                                                ...
                                                <div class="mt-3 mt-lg-0">
                                                    <div class="mb-3">
                                                        <select class="form-select w-25">
                                                            <option>Please Select Terminal</option>
                                                            <option>NPCT1</option>
                                                            <option>JICT</option>
                                                            <option>KOJA</option>
                                                        </select>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne1" class="accordion-collapse collapse show" aria-labelledby="headingOne1" data-bs-parent="#accordionExample1">
                                            <div class="accordion-body">
                                                ...
                                                <div align="right">
                                                    <button  type="button" onClick="nextSteps();" class="btn btn-info waves-effect waves-light"  data-bs-toggle="collapse" data-bs-target="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1">Check</button>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
