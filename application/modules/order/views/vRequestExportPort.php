				...
				<div class="tab-content twitter-bs-wizard-tab-content">
					<div class="tab-pane" id="steps-1">
						...
						<div class="card mt-3">
							<div class="card-body">
								<div class="row ">
									<div class="col-md-1" align="center" style="    justify-content: center; align-items: center; align-self: center; justify-self: center;">
									...
									<div class="col-md-9">
										<label style="font-weight: 700; font-size: 12px; line-height: 16px; letter-spacing: 0.02em; color: #002985;">Vessel Schedule</label>
										<div style="font-weight: 400; font-size: 12px; line-height: 16px; letter-spacing: 0.02em; color: #8C8CA2;">We also provide ship schedules for your reference</div>
									</div>
									<div class="col-md-2">
											...
											<div class="col-lg-8">
												<div>
													<div class="mb-3">
														...
														<select class="form-select" data-bs-toggle="modal" data-bs-target="#viewModal">
										...
										<div class="row mb-5">
											...
											<div class="col-md-6" style="text-align: end;">
												<span>
													...
													<input type="checkbox" onclick="chkall(this)" class="chk_custom">
												</span>
											</div>
										</div>
							...
							<div class="col-md-8">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<input type="checkbox" onclick="chkall(this);" class="" style="width: 20px; height: 20px;">
									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-12" align="center">
												...
												<!-- <button type="button" class="btn btn-outline-light waves-effect mt-4 w-100" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" style="border: none !important">Cancel Order</button> -->
											</div>
										</div>
									</div>
								</div>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body" align="center">
					...
					<div class="row">
						<div class="col-md-6 col-sm-6"><button style="width:80%;" type="button" class="btn btn-outline-secondary waves-effect" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center">Cancel Order</button></div>
						<div class="col-md-6 col-sm-6"><button style="width:80%;" type="button" class="btn btn-primary waves-effect waves-light">Save Order</button></div>
					</div>
				</div>
			</div><!-- /.modal-content -->
		</div><!-- /.modal-dialog -->
