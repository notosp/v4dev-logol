...
<div class="offcanvas offcanvas-start show" style="left: 70px !important; width: 200px; visibility: visible;" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel" aria-modal="true" role="dialog">
	...
	<div class="offcanvas-body">
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6">
				<div class="form-check mb-3">
					<input class="form-check-input" type="radio" name="formRadios" value="IMPORT" id="formRadiosImport" onclick="serviceRadio(this.value);" checked>
		...
		<div id="v4-service-export" style="display:none">
			...
			<div class="btn-group dropup w-100" id="divBtnDepot">
				<a href="<?php echo site_url('create-order-depo/export'); ?>" class="btn btn-outline-light waves-effect">E-Depot</a>
			</div>
		...
		<div class="btn-group dropup w-100">
			...
			<a href="<?php echo site_url('create-order-depo/import'); ?>" class="btn btn-primary dropdown-toggle dropdown-toggle-split w-10" aria-expanded="false" style="background-color:#86A8F8">
		...
		<div class="btn-group dropup w-100 mt-2">
			...
			<a href="<?php echo site_url('create-order-gatepass'); ?>" class="btn btn-primary dropdown-toggle dropdown-toggle-split w-10" aria-expanded="false" style="background-color:#86A8F8">
				<i class="mdi mdi-close"></i>
			</a>
		</div>
		<?php endif; ?>
		...
		<?php if($type == ""): ?>
		<p class="mt-3" style="font-size:12px;">Available Service to Add</p>	
		<div class="btn-group dropup w-100">
			<div class="btn-group dropup w-100">
				<a href="<?php echo site_url('create-order-gatepass/depot'); ?>" class="btn btn-outline-light waves-effect">E-Depot</a>
			</div>
		</div>
		<?php endif; ?>
		<div class="card mt-3" style="background: #F8F8F9;border: 2px dashed #BFC9E0;">
			<div class="card-body">
				<h4 class="card-title">Info</h4>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="mt-3 mt-lg-0">
									<div class="mb-3">
										<select class="form-select w-25" onchange="selectGatepass(this.value); return false;">
...
<path d="M17.7798 5.21973V8.09973" stroke="#002985" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
							...
							<div class="row mx-2">
								<div class="col-lg-8">&nbsp;</div>
								<div class="col-lg-4">
									<a type="button" class="btn btn-light waves-effect w-100 waves-light mb-sm-3" style="background-color:#497DF5;color:white" href="<?php echo ($type !="" ? site_url('create-order-gatepass-cart/'.$type) : site_url('create-order-gatepass-cart')); ?>">
										Continue
									</a>
								</div>
							</div>
