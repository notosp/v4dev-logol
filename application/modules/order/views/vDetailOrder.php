					...
					<div class="card-body">
						...
						<div class="row" style="margin-top:40px;">
							<div class="col-md-12 col-sm-12">
								...
								<span style="margin-left:100px;" class="badge rounded-pill badge-soft-primary">Send Email</span> &nbsp; <span class="badge rounded-pill badge-soft-primary">Download</span> &nbsp; <span class="badge rounded-pill badge-soft-success">Print</span>
							</div>
						</div>
