		...
		<div class="row">
		    <div class="navbar" >
                <div class="btn-group" role="group">
                    <input type="radio" class="btn-check" value="all" name="btnradio" id="all" autocomplete="off" onclick="getContent(this.value); return false;">
                    <label class="btn btn-outline-primary btn-list" id="act-all" for="all">All Order</label>
                    &nbsp; &nbsp;
                    <input type="radio" class="btn-check" value="draft" name="btnradio" id="draft" autocomplete="off" onclick="getContent(this.value); return false;">
                    <label class="btn btn-outline-primary btn-list" id="act-draft" for="draft">Draft</label>
                    &nbsp; &nbsp;
                    <input type="radio" class="btn-check" value="payment" name="btnradio" id="payment" autocomplete="off" onclick="getContent(this.value); return false;">
                    <label class="btn btn-outline-primary btn-list" id="act-payment" for="payment">Waiting Payment</label>
                    &nbsp; &nbsp;
                    <input type="radio" class="btn-check" value="progress" name="btnradio" id="progress" autocomplete="off" onclick="getContent(this.value); return false;">
                    <label class="btn btn-outline-primary btn-list" id="act-progress" for="progress">In Progress</label>
                    &nbsp; &nbsp;
                    <input type="radio" class="btn-check" value="issue" name="btnradio" id="issue" autocomplete="off" onclick="getContent(this.value); return false;">
