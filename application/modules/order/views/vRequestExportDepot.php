						...
						<div class="nav-title mt-5">
							<div class="row">
								...
								<div class="col-md-6 col-sm-6" style="justify-content: end; text-align: end;">
									<h5 style="color: #4A4A68;font-weight: 400; font-size: 12px;">Product Type</h5>
									<div>
													...
													<div class="col-lg-5 mt-3">
														<div class="card">
															<div class="card-body">
																<table>
																	<tr>
																		<td rowspan="2"><img src="<?php echo base_url('assets/images/cont-20-dv.png'); ?>" /></td>
																		<td style="width:100%;">
																			<label style="margin-left:8%;font-weight:bold;">20 Feet</label>
																			<label style="margin-left:8%;">General Purpose</label>
																		</td>
...
<script>
	...
	function addNewCont() {
		//alert('add new');
		$('#list-cont').append('<div class="col-md-4" id="contDetil">\
		<div class="alert-dismissible fade show">\
			<button type="button" onclick="removeContainer()" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>\
		</div>\
		<div class="card">\
			<div class="card-body">\
				<table>\
					<tr>\
						...
						<td style="width:100%;">\
							<select class="form-select" onchange="changeCont(this)" style="border:0;width:100%;">\
								<option  value="default">Select Container</option>\
								<option>20 Feet - General Purpose</option>\
								<option>40 Feet - General Purpose</option>\
								<option>45 Feet - High Cube</option>\
								<option>20 Feet - Reefer</option>\
								<option>40 Feet - Reefer High</option>\
							</select>\
		...
		<div class="modal-dialog modal-xl">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row mb-3">
						<div class="col-md-12">
							<input type="text" name="namaCustomer" class="form-control" placeholder="Onbehalf of Customer Name" />
						</div>
					</div>
					<div class="row mb-3">
						<div class="col-md-6">
