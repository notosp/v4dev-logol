													...
													<div class="mt-3 mt-lg-0">
														<div class="mb-3">
															<div>
																...
																<!-- <span class="icon-inside"><img src="<?php echo base_url('assets/images/icon/v4-input-file-icon.png'); ?>"/></span> -->
															</div>
														</div>
													</div>
												</div>
...
<script>
	...
	function addNewCont() {
		//alert('add new');
		$('#list-cont').append('<div class="col-lg-4">\
		<div class="card">\
...
<!--  Extra Large modal Add On Behalf Customer -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row mb-3">
					...
					<div class="col-md-6">
						<input type="file" name="upload" class="form-control" placeholder="Upload Onbhealf Of Customer" />
